...
class ExamCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Expanded(
                child: CustomText(exam.title, fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.primary),
              ),
              _buildBadge(exam),
            ],
          ),
          ...
          _infoRow(Icons.timer_sharp, 'المدة المتاحة:', '${exam.durationMinutes} دقيقة'),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: canStart ? const Color(0xFF10B981) : Colors.grey.shade400,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                elevation: 0,
              ),
              onPressed: canStart ? onStart : null,
              child: CustomText(
                exam.alreadySubmitted ? 'تم تسليم الإجابة' : (exam.isActive ? 'بدء الامتحان' : 'غير متاح حالياً'),
                color: Colors.white,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: CustomText(value, fontSize: 13, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
  ...
  Widget _buildBadge(ExamInfo exam) {
    ...
    return Container(
      ...
      child: CustomText(text, fontSize: 11, color: color, fontWeight: FontWeight.bold),
    );
  }
}